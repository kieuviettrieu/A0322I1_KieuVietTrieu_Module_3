package com.example.quan_ly_user_servlet_jdbc.controller;

import com.example.quan_ly_user_servlet_jdbc.dao.UserDAO;
...
public class UserServlet extends HttpServlet {
    ...
    private void searchUser(HttpServletRequest request, HttpServletResponse response)
        ...
        List<User> listUser = userDAO.selectAllUsers(nameSearch);
