...
public class Contract {
    ...
    public Contract(Date contract_start_date, Date contract_end_date, double contract_deposit, double contract_total_money) {
    ...
    public Contract(Date contract_start_date, Date contract_end_date, double contract_deposit,
