  ...
  <div>
    ...
    <div id="body_right">
      ...
      <div>
        <form method="post">
          <fieldset>
            <legend>Create Service Villa</legend>
            <table>
              <tr>
                <td>ID: </td>
              ...
              <tr>
                ...
                <td><input type="number" name="service_type_id" id="service_type_id" readonly value="1"></td>
              </tr>
              <tr>
                <td>Standard Room: </td>
                <td><input type="text" name="standard_room" class="standard_room"></td>
              </tr>
              <tr>
                  <td>Description Other Convenience: </td>
                  <td><input type="text" name="description_other_convenience" class="description_other_convenience"></td>
              </tr>
              <tr>
                  <td>Pool Area: </td>
                  <td><input type="number" name="pool_area" class="pool_area"></td>
              </tr>
              <tr>
                  <td>Number Of Floors: </td>
                  <td><input type="number" name="number_of_floors" class="number_of_floors"></td>
              </tr>
              <tr>
                <td></td>
