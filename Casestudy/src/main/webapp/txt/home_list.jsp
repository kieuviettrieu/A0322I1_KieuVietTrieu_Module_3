...
<div style="top: -8px; position: relative">
    ...
    <div>
        ...
        <div id="body_right">
            <c:if test="${action==list_employee}">
                <a href="/furama?action=create_employee">Create Employee</a>
                <a href="/furama?action=Employee">Return list</a>
                ...
                <table border="1">
                    ...
                    <c:forEach items='${requestScope["list_employee"]}' var="employee">
                        <tr>
                            ...
                            <td><a href="/furama?action=edit&id=${employee.getEmployee_id()}">edit</a></td>
                            <td><a href="/furama?action=delete&id=${employee.getEmployee_id()}">delete</a></td>
                        </tr>
                    </c:forEach>
                </table>
            </c:if>
            ...
            <c:if test="${action==list_customer}">
                <table border="1">
                    <a href="/furama?action=create_customer">Create Customer</a>
                    <a href="/furama?action=Customer"></a>
                    ...
                    <c:forEach items='${requestScope["list_customer"]}' var="customer">
                        <tr>
                            ...
                            <td><a href="/furama?action=edit&id=${customer.getCustomer_id()}">edit</a></td>
                            <td><a href="/furama?action=delete&id=${customer.getCustomer_id()}">delete</a></td>
                        </tr>
                    </c:forEach>
                </table>
            </c:if>
